...
export class BasketService {
 ...
 private addOrUpdateItem(items: BasketItem[], itemToAdd: BasketItem, quantity: number): BasketItem[] {
    const item = items.find(x => x.id === itemToAdd.id); // if we have item in basket that match the id , then we will hold it here in const
    ...
    // This will be stored in the local storage of the browser in form of key: value pair
    // will be sotred the id of the basket -> and will be available even after shutdown
  ...
  // This is working as automapper in the C# world
